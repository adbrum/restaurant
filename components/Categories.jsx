          ...
          <div className="row">
            <div className="col-sm-6 col-lg-6">
              <div className="single_food_item media">
                ...
                />
                <div className="media-body align-self-center">
                  <h3>Café / descafeinado / garoto / carioca de limão</h3>
                  {/* <p>They're wherein heaven seed hath nothing</p> */}
                  <h5>0,70€</h5>
                </div>
              </div>
          ...
          <div className="row">
            ...
            <div className="col-sm-6 col-lg-6">
              <div className="single_food_item media">
                ...
                <div className="media-body align-self-center">
                  <h3>
                    Tarte Gelada (natas, leite condensado, ovos moles, bolacha
                    Maria)
                  </h3>
                  {/* <p>They're wherein heaven seed hath nothing</p> */}
                  <h5>3,25€</h5>
          ...
          <div className="row">
            <div className="col-sm-6 col-lg-6">
              <div className="single_food_item media">
                ...
                />
                <div className="media-body align-self-center">
                  <h3>Vinho Tinto da Casa (vinho de mesa Vila de Frades)</h3>
                  {/* <p>They're wherein heaven seed hath nothing</p> */}
          ...
          <div className="row">
            <div className="col-sm-6 col-lg-6">
              <div className="single_food_item media">
                ...
                />
                <div className="media-body align-self-center">
                  <h3>Vinho Branco da Casa (vinho de mesa Vila de Frades)</h3>
                  {/* <p>They're wherein heaven seed hath nothing</p> */}
                  <h5>2€ (1/4l) / 3€ (1/2l) / 5€ (1l)</h5>
                </div>
              </div>
