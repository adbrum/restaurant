  ...
  (b = (function () {
    function c(c, d) {
      ...
      if (
        ((e.defaults = {
          ...
          asNavFor: null,
          prevArrow:
            '<button type="button" data-role="none" className="slick-prev">Previous</button>',
          nextArrow:
            '<button type="button" data-role="none" className="slick-next">Next</button>',
          autoplay: !1,
          autoplaySpeed: 3e3,
          centerMode: !1,
          centerPadding: "50px",
    ...
    (b.prototype.buildDots = function () {
      ...
      if (b.options.dots === !0 && b.slideCount > b.options.slidesToShow) {
        for (
          d = '<ul className="' + b.options.dotsClass + '">', c = 0;
          c <= b.getDotCount();
          c += 1
        )
